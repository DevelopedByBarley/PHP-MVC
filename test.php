...
<div class="section d-flex  align-items-center justify-content-center">
    <div class="container rounded mx-auto  d-flex align-items-center justify-content-center">
        <div class="row dark-bg-gray-900">
            ...
            <div class="col-12 col-lg-8">
                <?php if ($adminLevel === 3) ?>
                <div class="container-fluid d-flex p-5 my-5 align-items-start justify-content-center flex-column-reverse gap-5 table-responsive  max-h-500 overflow-y-scroll overflow-x-scroll">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <p class="fw-bold mb-1">Barley</p>
                                            <p class="text-muted mb-0">developedbybarley@gmail.com</p>
                                        </div>
                                    </div>
                                </td>
                                <td>
